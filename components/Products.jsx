...
export default function Products(props) {
    ...
    //     Docker: "Platform for containering, deploying, and scaling applications",
    ...
    //     PostgreSQL: "Robust open-source database woth advanced querying",
    //     ReactJS: "Javasript library for building interactive user interfaces"

    // }
    // const stickersKeys = Object.keys(stickerDescriptions)
    ...
    return (
        <>
                ...
                <div className="planner-container" id="planner">
                    ...
                    <div className="planner-info">
                        ...
                        <div className="purchase-btns">
                            <button onClick={() => {
                                const plannerPriceId = planner.prices[0].id  //can use sticker.default_price if we have only one price variant
            ...
            <div className="section-container">
                ...
                <div className="sticker-container" id="sticker">
                    {stickers.map((sticker, stickerIndex) => {
                        const stickerName = sticker.name
                        const stickerImgUrl = stickerName.replaceAll(' Sticker.png', '').replaceAll(' ', "_")
                        return (
                            <div key={stickerIndex} className="sticker-card">
                                ...
                                <div className="sticker-info">
                                    ...
                                    <button onClick={() => {
                                        const stickerPriceId = sticker.prices[0].id //can use sticker.default_price if we have only one price variant
